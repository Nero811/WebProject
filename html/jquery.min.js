...
$("#login").click(() => {
  let userData = {};
  let loginModal = document.querySelector("#user-login-Modal");
...
function displayPassword() {
  console.log("here!!");
  let password = document.getElementById("InputPassword-registry");
  if (password.type == "password") {
    password.type = "text";
  } else {
    password.type = "password";
...
$("#registry").click(() => {
  let userData = {};
  let registryModal = document.querySelector("#user-registry-Modal");
  let email = document.getElementById("InputEmail-registry");
  let password = document.getElementById("InputPassword-registry");
  registryModal.showModal();

  // 按取消鍵關閉dialog
  $("#cancle-registry").click(() => {
    email.value = "";
    password.value = "";
    registryModal.close(undefined);
  });
  // 按submit鍵連接api;
  $("#submit-registry").click(() => {
    console.log("click!!");
...
$("#createProductSubmit").click(() => {
  ...
  // 商品類別
  let categoryCheck = document.getElementsByClassName(
    "create-form-check-input"
  );
